   ...
   <div class="jumbotron text-center">
    ...
    <div class="container-fluid text-center bg-grey">
      ...
      <div class="col-sm-3">
        <div class="thumbnail">
          <div class="panel panel-default text-center">
          <img src="bt21/Aksesoris_2.jpeg" alt="aksesoris" width="400" height="300">
          <p><strong>Gelang BT21(Unofficial)</strong></p>
          <p>
            <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 35.000</a>
          </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="thumbnail">
          <div class="panel panel-default text-center">
            <img src="bt21/Aksesoris_3.jpeg" alt="aksesoris" width="400" height="300">
            <p><strong>Jepit</strong></p>
            <p>
              <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 8.000</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="thumbnail">
          <div class="panel panel-default text-center">
            <img src="bt21/Aksesoris_4.jpeg" alt="aksesoris" width="400" height="300">
            <p><strong>Kuas Make-up(sepaket)</strong></p>
            <p>
              <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 80.000</a>
            </p>
          </div>
        </div>
      </div>

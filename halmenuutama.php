    ...
    <div class="container-fluid text-center bg-grey">
      <div class="row text-center">
        ...
        <div class="col-sm-3">
          <div class="thumbnail">
            <div class="panel panel-default text-center">
              <img src="bt21/Aksesoris_1.jpeg" alt="aksesoris" width="400" height="300">
              <p><strong>Gelang(Unofficial)</strong></p>
              <p>
                <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 30.000</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="thumbnail">
            <div class="panel panel-default text-center">
              <img src="bt21/sendal_1.jpeg" alt="Sendal" width="400" height="300">
              <p><strong>Sendal BT21 (Unofficial)</strong></p>
              <p>
                <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 25.000</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="thumbnail">
            <div class="panel panel-default text-center">
              <img src="bt21/koper_2.jpeg" alt="Koper" width="400" height="300">
              <p><strong>Koper BT21 (Official)</strong></p>
              <p>
                <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 1.360.000</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="thumbnail">
            <div class="panel panel-default text-center">
              <img src="bt21/Boneka_1.jpeg" alt="Boneka" width="400" height="300">
              <p><strong>Boneka led BT21 (Unofficial)</strong></p>
              <p>
                <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 70.000</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="thumbnail">
            <div class="panel panel-default text-center">
              <img src="bt21/Baju_3.jpeg" alt="Baju" width="400" height="300">
              <p><strong>Baju shirt BT21 (Official)</strong></p>
              <p>
                <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 125.000</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="thumbnail">
            <div class="panel panel-default text-center">
              <img src="bt21/Kipas_1.jpeg" alt="Kipas" width="400" height="300">
              <p><strong>Kipas BT21 (Unofficial)</strong></p>
              <p>
                <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 45.000</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="thumbnail">
            <div class="panel panel-default text-center">
              <img src="bt21/tempatpensil.jpeg" alt="aksesoris" width="400" height="300">
              <p><strong>Tempat pensil (Unofficial)</strong></p>
              <p>
                <a class="btn btn-primary" href="#">Beli</a> <a class="btn" href="#">Rp 9.000</a>
              </p>
            </div>
          </div>
        </div>
